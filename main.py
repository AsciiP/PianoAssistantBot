...
# Choose a note mapping
print('1. VR Piano\n2. Clay')
mapping_type = int(input('输入映射类型编号：'))
match mapping_type:
    case 1:
...
# Choose a file in .\songs\ folder
print("选择一个文件：")
for i, file in enumerate(os.listdir("songs")):
    print("{}. {}".format(i, file))
file = "songs/" + os.listdir("songs")[int(input("输入文件编号："))]
